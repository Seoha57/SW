...
public class VerticalDelayedSlider : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    FillPosition = FillTransform.anchoredPosition.y;

    if (UseDelayed)
    {
      DelayedFill.SetActive(true);
      DelayedFillSize = DelayedFillTransform.sizeDelta;
      DelayedFillPosition = DelayedFillTransform.anchoredPosition.y;
